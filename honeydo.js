...
var appendTask = function (task, desc, goal, loc) {
  var newData = {
    "task": task,
    "description": desc,
    "dept": loc,
...
var getLocation = function (loc) {
  ...
  switch (loc) {
    ...
    case "camper":
      ...
      break;
    case "popup":
      location = 'Pop-Up Camper';
      break;
    case "trailer":
      location = 'Utility Trailer';
      break;
    case "samantha":
      location = 'Samantha';
      break;
